...
pub fn setup_cni_network(
    ...
    let tap_name = format!("vmtap-{}", &container_id[0..std::cmp::min(8, container_id.len())]);
    ...
    println!("[cni] Successfully configured host TAP device: {}", tap_name);
